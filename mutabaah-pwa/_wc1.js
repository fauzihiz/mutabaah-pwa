...
const p2 = `crown:({className:c})=><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={c}><path d="m2 4 3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14"/></svg>,
...
fs.writeFileSync(b+'/components/dashboard/AchievementCarousel.tsx', p1+p2);
